...
param parAllowForwardedTraffic bool = false
...
resource resVirtualNetworkPeer 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2023-02-01' = {
  name: '${parSourceVirtualNetworkName}/peer-${parDestinationVirtualNetworkName}'
  properties: {
...
output outVirtualNetworkPeerId string = resVirtualNetworkPeer.id
output outVirtualNetworkPeerName string = resVirtualNetworkPeer.name
