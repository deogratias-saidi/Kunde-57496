...
var varCustomPolicySetDefinitionsArray = [
	...
	// Unused resources driving cost should be avoided
	{
	...
	// Enforces DenyAction - Delete on Activity Log Settings and Diagnostic Settings.
	{
	...
	// Enforce policies in the Decommissioned Landing Zone
	{
	...
	//Enforce recommended guardrails for Key Vault
	{
